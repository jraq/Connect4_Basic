...
class GameStore implements IGameStore {
    ...
    private updateBoard = () => {
        ...
        this.game.moves.forEach((item) => {
            switch (item) {
                case 0: {
                    this.board[row0Count].row[item] = currentPlayer;
                    row0Count++;
                }
                    break;
                case 1: {
                    this.board[row1Count].row[item] = currentPlayer;
                    row1Count++;
                }
                    break;
                case 2: {
                    this.board[row2Count].row[item] = currentPlayer;
                    row2Count++;
                }
                    break;
                case 3: {
                    this.board[row3Count].row[item] = currentPlayer;
                    row3Count++;
                }
                    break;
                default:
